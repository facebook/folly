...
function(folly_define_tests)
  ...
  while (cur_test LESS test_count)
    if (
         ("x${test_${cur_test}_tag}" STREQUAL "x")
      # TODO: Use IN_LIST after cmake 3.3
      OR (test_${cur_test}_tag MATCHES "\\bBROKEN\\b" AND BUILD_BROKEN_TESTS)
      OR (test_${cur_test}_tag MATCHES "\\bSLOW\\b" AND BUILD_SLOW_TESTS)
      OR (test_${cur_test}_tag MATCHES "\\bHANGING\\b" AND BUILD_HANGING_TESTS)
      OR (test_${cur_test}_tag MATCHES "\\bWINDOWS_DISABLED\\b" AND NOT WIN32)
      OR (test_${cur_test}_tag MATCHES "\\bAPPLE_DISABLED\\b" AND NOT APPLE)
    )
