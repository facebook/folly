...
TEST_F(TraitsTest, function_traits) {
  ...
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*)>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) const>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) volatile>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) const volatile>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*)&>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) const&>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) volatile&>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) const volatile&>));
  ...
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) volatile&&>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) const volatile&&>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) noexcept>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) const noexcept>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) volatile noexcept>));
  EXPECT_TRUE(( //
      is_argument_type_v<vc*, 1, void(int, vc*) const volatile noexcept>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*)& noexcept>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) const& noexcept>));
  EXPECT_TRUE((is_argument_type_v<vc*, 1, void(int, vc*) volatile& noexcept>));
  EXPECT_TRUE(( //
  ...
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float)>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) const>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) volatile>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) const volatile>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float)&>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) const&>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) volatile&>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) const volatile&>));
  ...
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) volatile&&>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) const volatile&&>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) noexcept>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) const noexcept>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) volatile noexcept>));
  EXPECT_EQ(
      3, (arguments_size_v<void(int, vc*, float) const volatile noexcept>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float)& noexcept>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) const& noexcept>));
  EXPECT_EQ(3, (arguments_size_v<void(int, vc*, float) volatile& noexcept>));
  EXPECT_EQ(
