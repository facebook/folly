...
CRC_EXPORT uint32_t
sse_crc32c_v8s3x3(const uint8_t* buf, size_t len, uint32_t crc0) {
  ...
  if (len >= 208) {
    ...
    while (len >= 208) {
      ...
      y4 = _mm_xor_si128(y4, _mm_loadu_si128((const __m128i*)(buf2 + 64))),
      x4 = _mm_xor_si128(x4, y4);
      y5 = _mm_xor_si128(y5, _mm_loadu_si128((const __m128i*)(buf2 + 80))),
      x5 = _mm_xor_si128(x5, y5);
      y6 = _mm_xor_si128(y6, _mm_loadu_si128((const __m128i*)(buf2 + 96))),
      x6 = _mm_xor_si128(x6, y6);
      y7 = _mm_xor_si128(y7, _mm_loadu_si128((const __m128i*)(buf2 + 112))),
      x7 = _mm_xor_si128(x7, y7);
      crc0 = _mm_crc32_u64(crc0, *(const uint64_t*)buf);
    ...
    vc ^= _mm_extract_epi64(
        crc_shift(
            _mm_crc32_u64(
                _mm_crc32_u64(0, _mm_extract_epi64(x0, 0)),
