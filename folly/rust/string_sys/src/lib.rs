...
// Include bindings generated by bindgen
// For Cargo: build.rs writes to OUT_DIR/bindings.rs
// For buck2: rust_bindgen_library sets OUT_DIR="src" and maps bindings.rs to src/bindings.rs
