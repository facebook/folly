...
#define CXX_STDLIB_COMPATIBLE 1
#else
#define CXX_STDLIB_COMPATIBLE 0
#endif // (defined(__GLIBCXX__) || defined(_LIBCPP_VERSION))

#if (!defined(__FreeBSD__) && !_WIN32)
#define OS_CXX_ABI_COMPATIBLE 1
#else
#define OS_CXX_ABI_COMPATIBLE 0
#endif // (!defined(__FreeBSD__) && ! _WIN32)

#if CXX_STDLIB_COMPATIBLE && OS_CXX_ABI_COMPATIBLE
