...
class IOBuf(Hashable):
    ...
    # Note that this gives you the bytes of the current IOBuf, for the whole IOBuf iterate through it or use `chain_bytes()`
...
def copy_from_buffer(
    data: Union[bytes, bytearray, memoryview], length: Optional[int] = None
) -> IOBuf: ...
