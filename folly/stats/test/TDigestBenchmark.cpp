...
BENCHMARK_DRAW_LINE();
// mergeImpl N x K sweep (K digests of N centroids). K=2 uses merge2Impl.
BENCHMARK_NAMED_PARAM(mergeDigests, 100x2, 100, 2)
BENCHMARK_NAMED_PARAM(mergeDigests, 100x3, 100, 3)
BENCHMARK_NAMED_PARAM(mergeDigests, 100x4, 100, 4)
BENCHMARK_NAMED_PARAM(mergeDigests, 100x8, 100, 8)
BENCHMARK_NAMED_PARAM(mergeDigests, 100x16, 100, 16)
BENCHMARK_NAMED_PARAM(mergeDigests, 100x32, 100, 32)
BENCHMARK_NAMED_PARAM(mergeDigests, 100x60, 100, 60)
BENCHMARK_NAMED_PARAM(mergeDigests, 100x100, 100, 100)
BENCHMARK_DRAW_LINE();
BENCHMARK_NAMED_PARAM(mergeDigests, 1000x2, 1000, 2)
BENCHMARK_NAMED_PARAM(mergeDigests, 1000x3, 1000, 3)
BENCHMARK_NAMED_PARAM(mergeDigests, 1000x4, 1000, 4)
BENCHMARK_NAMED_PARAM(mergeDigests, 1000x8, 1000, 8)
BENCHMARK_NAMED_PARAM(mergeDigests, 1000x16, 1000, 16)
BENCHMARK_NAMED_PARAM(mergeDigests, 1000x32, 1000, 32)
BENCHMARK_NAMED_PARAM(mergeDigests, 1000x60, 1000, 60)
BENCHMARK_NAMED_PARAM(mergeDigests, 1000x100, 1000, 100)
