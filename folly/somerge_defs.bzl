...
@generated SignedSource<<acaeeed0a7d917698c492180e0b3dd07>>
"""
...
FOLLY_NATIVE_LIBRARY_MERGE_MAP = [
    ...
    "fbsource//xplat/folly/lang:cstring_view$",
    "fbsource//xplat/folly/lang:cstring_viewAndroid$",
    ...
    "fbsource//xplat/folly/system/arch:x86$",
    "fbsource//xplat/folly/system/arch:x86Android$",
...
FOLLY_BASE_NATIVE_LIBRARY_MERGE_MAP = [
    ...
    "fbsource//xplat/folly/detail:avx2$",
    "fbsource//xplat/folly/detail:avx2Android$",
    ...
    "fbsource//xplat/folly/external/rapidhash:rapidhash$",
    "fbsource//xplat/folly/external/rapidhash:rapidhashAndroid$",
    ...
    "fbsource//xplat/folly/random:seed_seq$",
    "fbsource//xplat/folly/random:seed_seqAndroid$",
...
FOLLY_EXTENDED_NATIVE_LIBRARY_MERGE_MAP = [
    ...
    "fbsource//xplat/folly/io/async:io_uring_backend$",
    "fbsource//xplat/folly/io/async:io_uring_backendAndroid$",
    "fbsource//xplat/folly/io/async:io_uring_connect$",
    "fbsource//xplat/folly/io/async:io_uring_connectAndroid$",
    "fbsource//xplat/folly/io/async:io_uring_provided_buffer_ring$",
    "fbsource//xplat/folly/io/async:io_uring_provided_buffer_ringAndroid$",
    "fbsource//xplat/folly/io/async:io_uring_recv$",
    "fbsource//xplat/folly/io/async:io_uring_recvAndroid$",
    "fbsource//xplat/folly/io/async:io_uring_send$",
    "fbsource//xplat/folly/io/async:io_uring_sendAndroid$",
    "fbsource//xplat/folly/io/async:io_uring_zero_copy_buffer_pool$",
    "fbsource//xplat/folly/io/async:io_uring_zero_copy_buffer_poolAndroid$",
    "fbsource//xplat/folly/io/async:liburing$",
    "fbsource//xplat/folly/io/async:liburingAndroid$",
    ...
    "fbsource//xplat/folly/system:shell$",
    "fbsource//xplat/folly/system:shellAndroid$",
    ...
    "fbsource//xplat/folly:subprocess$",
    "fbsource//xplat/folly:subprocessAndroid$",
    "fbsource//xplat/folly:synchronization_lock$",
    "fbsource//xplat/folly:synchronization_lockAndroid$",
    "fbsource//xplat/folly:token_bucket$",
    "fbsource//xplat/folly:token_bucketAndroid$",
]
