...
template <typename>
class ExtendedCoroutinePromiseImpl;
 ...
 public:
  ...
  class PromiseBase {
   private:
    ...
    template <typename>
    friend class ExtendedCoroutinePromiseImpl;
...
//   (1) Publicly inherit from `ExtendedCoroutinePromiseImpl<YourPromise>`,
