...
Each round reports adaptive p33.3 timings, so these are medians-of-p33.3.
...
| median | benchmark | target | before ± Δ |
| ---: | --- | --- | ---: |
...
| median | benchmark | target | before ± Δ |
| ---: | --- | --- | ---: |
| 15.0-0.8ns (-5.3%) | low_win | fbcode//folly/test:bench | 10.0-0.6, 15.0-0.8, *(20.0-0.2)* |

## Low-priority regressions

| median | benchmark | target | before ± Δ |
| ---: | --- | --- | ---: |
| 15.0+0.8ns (+5.3%) | low_loss | fbcode//folly/test:bench | 10.0+0.6, 15.0+0.8, *(20.0+0.2)* |

## High-priority regressions

| median | benchmark | target | before ± Δ |
| ---: | --- | --- | ---: |
| 1.5+1.5ns | same_name (loss.cpp) | fbcode//folly/test:bench | 1.0+2.0, 1.5+1.5, *(2.0+0.2)* |
