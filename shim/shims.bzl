...
load("@prelude//utils:type_defs.bzl", "is_select", "is_tuple", "is_list")
...
def prebuilt_cpp_library(
    ...
    **kwargs,
    ...
    prelude.prebuilt_cxx_library(exported_headers = headers,
        exported_linker_flags = linker_flags,
        linker_flags = private_linker_flags, **kwargs)
